      ...
      items: [
        {
          ...
          color: "Fresh Green",
          qty: 20,
          img: "https://img.freepik.com/free-photo/green-grass_1417-1672.jpg"
        },
        {
          name: "Super Napier Rooted Saplings",
          color: "Natural Green",
          qty: 10,
          img: "https://img.freepik.com/free-photo/flat-lay-salad-s-root_23-2149198283.jpg"
        },
        {
      ...
      items: [
        {
          ...
          color: "Fresh Green",
          qty: 15,
          img: "https://img.freepik.com/free-photo/blades-grass_1259-86.jpg"
        }
      ],
      ...
      <div className="space-y-8">
        {orders.map((order, idx) => (
          <div key={idx} className="bg-white rounded-3xl shadow-sm overflow-hidden border border-gray-100">
            ...
            {/* Status */}
            <div className="px-6 py-4 flex flex-col md:flex-row md:items-center gap-2 md:gap-3">

              <span
                className={`px-3 py-1 rounded-full text-xs font-medium border w-fit ${order.status === "Accepted"
              ...
              <div className="flex flex-wrap gap-3">
                {order.actions.map((action) => (
                  action !== "Cancel Order" && (
                    <button
                      key={action}
                      className={`px-5 py-2 rounded-xl text-sm font-medium border transition-colors ${action === "Track Order" || action === "Add Review"
