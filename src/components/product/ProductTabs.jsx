...
import { FileText, ListOrdered, PlayCircle } from 'lucide-react';
                                ...
                                {product.howToUse && product.howToUse.length > 0 ? (
                                    <ol className="space-y-5">
                                        {product.howToUse.map((step, idx) => (
                                            ...
                                            >
                                                <span className="flex-shrink-0 w-7 h-7 rounded-full bg-[#1B5E20] text-white text-xs font-bold flex items-center justify-center mt-0.5">
                                                    {idx + 1}
                                                </span>
                                                <p className="text-gray-600 text-base leading-relaxed">{step}</p>
                                            </motion.li>
                                        ))}
                                    </ol>
                                ) : (
                                    <p className="text-gray-500">No instructions available for this product.</p>
                                )}
                            </motion.div>
                        )}
