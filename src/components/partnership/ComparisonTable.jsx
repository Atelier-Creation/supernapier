    ...
    <section className="py-16 md:py-24 bg-white overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12 md:mb-16" data-aos="fade-up">
          <h2 className="text-3xl md:text-5xl font-bold text-deep-forest mb-4">{title}</h2>
          ...
          <table className="w-full text-left border-collapse min-w-[700px]">
            <thead>
              <tr className="bg-deep-forest text-slate-white">
                <th className="p-4 md:p-8 text-base md:text-xl font-bold">{columns[0] || "Parameters"}</th>
                <th className="p-4 md:p-8 text-base md:text-xl font-bold bg-earthy-gold text-deep-forest relative">
                  {columns[1] || "Slips (Our Choice)"}
                ...
                <th className="p-4 md:p-8 text-base md:text-xl font-bold opacity-70">{columns[2] || "Tissue Culture"}</th>
                <th className="p-4 md:p-8 text-base md:text-xl font-bold opacity-70">{columns[3] || "Seeds"}</th>
              </tr>
            </thead>
