...
const iconMap = {
  Zap: <Zap className="w-12 h-12 text-earthy-gold" />,
  ShieldCheck: <ShieldCheck className="w-12 h-12 text-earthy-gold" />,
  TrendingUp: <TrendingUp className="w-12 h-12 text-earthy-gold" />,
};
          ...
          {pillars.map((pillar, index) => (
            ...
            >
              ...
              <div className="mb-6 inline-block p-4 bg-slate-white rounded-2xl group-hover:scale-110 transition-transform">
                {iconMap[pillar.iconName] || iconMap["Zap"]}
              </div>
