...
const StatsGrid = ({ config }) => {
  const {
    ...
    stats = [
      ...
      { label: "Crude Protein", value: "18", suffix: "%", color: "text-[#a3e635]", glow: "shadow-[0_0_20px_rgba(163,230,53,0.2)]" },
      { label: "Regrowth Cycle", value: "45", suffix: "Days", color: "text-white", glow: "shadow-[0_0_20px_rgba(255,255,255,0.1)]" },
      { label: "Water Efficiency", value: "95", suffix: "%", color: "text-[#22d3ee]", glow: "shadow-[0_0_20px_rgba(34,211,238,0.2)]" }
    ]
  } = config || {};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-6" data-aos="zoom-in">
            {stats.map((stat, index) => (
              ...
              >
                <div className={`text-2xl sm:text-3xl md:text-5xl font-black mb-2 md:mb-3 drop-shadow-sm ${stat.color || "text-white"}`}>
                  {stat.value}
